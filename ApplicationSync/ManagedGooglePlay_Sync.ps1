...
function Get-WindowsManagedStoreAccount {
...
.EXAMPLE
Get-WindowsManagedStoreAccount 
Returns the Managed Google Play configuration from Intune 
.NOTES
NAME: Get-WindowsManagedStoreAccount
#>

    
$graphApiVersion = "beta"
$Resource = "deviceManagement/windowsManagedStoreAccountEnterpriseSettings"
...
function Sync-WindowsManagedStoreAccount {
...
.EXAMPLE
Sync-WindowsManagedStoreAccount
Initiates a Managed Google Play Sync in Intune
.NOTES
NAME: Sync-WindowsManagedStoreAccount
#>

    
$graphApiVersion = "beta"
$Resource = "deviceManagement/windowsManagedStoreAccountEnterpriseSettings/syncApps"
...
if((Get-WindowsManagedStoreAccount).bindStatus -ne "notBound"){

    Write-Host "Found Managed Google Play Configuration. Performing Sync..." -ForegroundColor Yellow
    
    $ManagedPlaySync = Sync-WindowsManagedStoreAccount
