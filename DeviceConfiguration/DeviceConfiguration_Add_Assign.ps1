...
Write-Verbose "Resource: $DCP_resource"
    ...
    try {
        ...
        write-host "No JSON specified, please specify valid JSON for the Windows Policy..." -f Red
...
{
    "@odata.type": "#microsoft.graph.windowsGeneralDeviceConfiguration",
    "description": "",
    "displayName": "Windows Device Restriction Policy",
...
$Assign_Windows = Add-DeviceConfigurationPolicyAssignment -ConfigurationPolicyId $CreateResult_Windows.id -TargetGroupId $TargetGroupId -AssignmentType Included
