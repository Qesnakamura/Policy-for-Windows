...

{
  ...
  "displayName": "Graph MAM Windows Policy",
  "description": "Graph MAM Windows Policy",
  ...
  "apps": [
    {
        "mobileAppIdentifier": {
        "@odata.type": "#microsoft.graph.windowsMobileAppIdentifier",
...
write-host "Adding Windows Managed App Policy" -f Yellow

Add-ManagedAppPolicy -Json $Windows
