...
.EXAMPLE
Add-WindowsApplication -JSON $JSON -IconURL pathtourl
Adds an Windows application into Intune using an icon from a URL
.NOTES
...
$Create_Outlook = Add-WindowsApplication -JSON $Outlook -IconURL "$iconUrl_Outlook"
...
$Create_Browser = Add-WindowsApplication -JSON $Browser -IconURL "$iconUrl_Browser"
...
$Create_Excel = Add-WindowsApplication -JSON $Excel -IconURL "$iconUrl_Excel"
