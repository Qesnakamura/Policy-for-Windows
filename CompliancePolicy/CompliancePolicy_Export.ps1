...
.EXAMPLE
Get-DeviceCompliancePolicy -Windows
Returns any device compliance policies for Windows configured in Intune
.EXAMPLE
...
$Resource = "deviceManagement/deviceCompliancePolicies"
    ...
    try {
        ...
        write-host "Multiple parameters set, specify a single parameter -Windows -iOS or -Win10 against the function" -f Red
        ...
        (Invoke-RestMethod -Uri $uri -Headers $authToken -Method Get).Value | Where-Object { ($_.'@odata.type').contains("windows") }
