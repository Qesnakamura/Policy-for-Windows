...
Adds an Windows device compliance policy in Intune
.NOTES
...
$JSON_Windows = @"
    ...
    "displayName":  "Windows Compliance Policy Assigned",
...
$Assign_Windows = Add-DeviceCompliancePolicyAssignment -CompliancePolicyId $CreateResult_Windows.id -TargetGroupId $TargetGroupId
